...
const long BLINDNESS_DURATION = 600;
int stage = -1;
bool isMoving = true;
...
const int START_PANIC_AFTER = 2500;
...
const int MOVE_TOWARDS_CONE_DURATION = 1300;
const int MOVE_INTO_MAZE_DURATION = 600;
const int DISABLE_LINE_DETECTORS_DURATION = 18000;
...
void setup() {
  ...
  while (true) {
    ...
    if (getDistanceF > 0 && getDistanceF < 20) {
  ...
  waitForCertainDuration(STOP_DURATION);
  moveForwardForCertainDuration(BASE_SPEED, MOVE_INTO_MAZE_DURATION);
